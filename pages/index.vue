...
<template>
  <div class="w-full z-0 text-lighty-black dark:text-lighty-black">
    <div class="container-custom">
      <h1 class="dark:text-white">Mistrzostwa Świata 2022</h1>
      <h2 class="dark:text-white">Fifa - World Cup 2022</h2>
      <div class="tournament-bracket tournament-bracket--rounded">
        <div
          ...
          "
        >
          <h3 class="tournament-bracket__round-title">Ćwierćfinał</h3>
          <ul class="tournament-bracket__list">
            <li class="tournament-bracket__item">
              <div class="tournament-bracket__match" tabindex="0">
                <table class="tournament-bracket__table">
                  <caption class="tournament-bracket__caption">
                    <time datetime="2022-12-09">9 Grudnia 2022</time>
                  </caption>
                  <thead class="sr-only">
                    <tr>
                      <th>Country</th>
                  ...
                  <tbody class="tournament-bracket__content">
                    ...
                    >
                      <td class="tournament-bracket__country">
                        ...
                        >
                        <span
                          class="tournament-bracket__flag fi fi-ar"
                          aria-label="Flag"
                        ></span>
                      </td>
                    ...
                    <tr class="tournament-bracket__team">
                      <td class="tournament-bracket__country">
                        <abbr class="tournament-bracket__code" title="Holandia"
                          >NED</abbr
                        >
                        <span
                          class="tournament-bracket__flag fi fi-nl"
                          aria-label="Flag"
                        ></span>
                      </td>
                      <td class="tournament-bracket__score">
              ...
              <div class="tournament-bracket__match" tabindex="0">
                <table class="tournament-bracket__table">
                  ...
                  <tbody class="tournament-bracket__content">
                    ...
                    <tr class="tournament-bracket__team">
                      <td class="tournament-bracket__country">
                        <abbr class="tournament-bracket__code" title="Brazylia"
                          >BRA</abbr
                        >
                        <span
                          class="tournament-bracket__flag fi fi-br"
                          aria-label="Flag"
                        ></span>
                      </td>
                      <td class="tournament-bracket__score">
            ...
            <li class="tournament-bracket__item">
              <div class="tournament-bracket__match" tabindex="0">
                <table class="tournament-bracket__table">
                  <caption class="tournament-bracket__caption">
                    <time datetime="2022-12-10">10 Grudnia 2022</time>
                  </caption>
                  <thead class="sr-only">
                    <tr>
                      <th>Country</th>
                  ...
                  <tbody class="tournament-bracket__content">
                    ...
                    >
                      <td class="tournament-bracket__country">
                        <abbr class="tournament-bracket__code" title="Anglia"
                          >ENG</abbr
                        >
                        <span
                          class="tournament-bracket__flag fi fi-gb-eng"
                          aria-label="Flag"
                        ></span>
                      </td>
                      <td class="tournament-bracket__score">
                  ...
                  <tbody class="tournament-bracket__content">
                    ...
                    <tr class="tournament-bracket__team">
                      <td class="tournament-bracket__country">
                        ...
                        >
                        <span
                          class="tournament-bracket__flag fi fi-pt"
                          aria-label="Flag"
                        ></span>
                      </td>
                      <td class="tournament-bracket__score">
        ...
        <div
          ...
          "
        >
          <h3 class="tournament-bracket__round-title">Półfinał</h3>
          <ul class="tournament-bracket__list">
            <li class="tournament-bracket__item">
              <div class="tournament-bracket__match" tabindex="0">
                <table class="tournament-bracket__table">
                  <caption class="tournament-bracket__caption">
                    <time datetime="2022-12-13">13 Grudnia 2022</time>
                  </caption>
                  <thead class="sr-only">
                    <tr>
                      <th>Country</th>
            ...
            <li class="tournament-bracket__item">
              <div class="tournament-bracket__match" tabindex="0">
                <table class="tournament-bracket__table">
                  <caption class="tournament-bracket__caption">
                    <time datetime="2022-12-14">14 Grudnia 2022</time>
                  </caption>
                  <thead class="sr-only">
                    <tr>
                      <th>Country</th>
        ...
        >
          <h3 class="tournament-bracket__round-title">3 miejsce</h3>
          <ul class="tournament-bracket__list">
            <li class="tournament-bracket__item">
              <div class="tournament-bracket__match" tabindex="0">
                <table class="tournament-bracket__table">
        ...
        <div class="tournament-bracket__round tournament-bracket__round--gold">
          <h3 class="tournament-bracket__round-title">Finał</h3>
          <ul class="tournament-bracket__list">
            <li class="tournament-bracket__item">
              <div class="tournament-bracket__match" tabindex="0">
                <table class="tournament-bracket__table">
...
@font-face {
  ...
  font-style: normal;
  font-weight: 300;
  src: url(https://fonts.gstatic.com/s/worksans/v18/QGY_z_wNahGAdqQ43RhVcIgYT2Xz5u32KxfXBiEJow.ttf)
    format("truetype");
}
@font-face {
  font-family: "Work Sans";
  font-style: normal;
  font-weight: 400;
  src: url(https://fonts.gstatic.com/s/worksans/v18/QGY_z_wNahGAdqQ43RhVcIgYT2Xz5u32K0nXBiEJow.ttf)
    format("truetype");
}
@font-face {
  font-family: "Work Sans";
  font-style: normal;
  font-weight: 600;
  src: url(https://fonts.gstatic.com/s/worksans/v18/QGY_z_wNahGAdqQ43RhVcIgYT2Xz5u32K5fQBiEJow.ttf)
    format("truetype");
}
@font-face {
  font-family: "Work Sans";
  font-style: normal;
  font-weight: 700;
  src: url(https://fonts.gstatic.com/s/worksans/v18/QGY_z_wNahGAdqQ43RhVcIgYT2Xz5u32K67QBiEJow.ttf)
    format("truetype");
}
*,
*::before,
...
@media (min-width: 46em) and (max-width: 52em) {
  .tournament-bracket__content .tournament-bracket__team:first-child {
